...
import FeeForm from './components/Features/FeeForm'; import ChatApp from './components/Features/ChatApp'; import TeacherDashboard from './components/Teacher/TeacherDashboard';
function App() {
  return (
    <Router>
      <Routes>
